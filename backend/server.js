...
import secretLoungeAdminRoutes from './routes/secretLoungeAdminRoutes.js';
...
app.use('/api/dm', adminLimiter, dmRoutes);
app.use('/api/secret-lounge-admin', adminLimiter, secretLoungeAdminRoutes);
