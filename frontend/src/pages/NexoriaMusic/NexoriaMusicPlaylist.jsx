        ...
        {tracks.length === 0 ? (
          <div className="text-center py-20">
            <div className="inline-block p-6 rounded-full bg-white/5 mb-4">
              <MoreHorizontal className="w-12 h-12 text-[#a7a7a7]" />
            </div>
          ...
          <>
            {/* Table Header */}
            <div className="grid grid-cols-[16px_minmax(120px,_4fr)_minmax(120px,_2fr)_minmax(120px,_1fr)] gap-4 px-4 py-2 text-sm text-[#a7a7a7] border-b border-white/10 mb-4 sticky top-16 bg-[#121212] z-10 uppercase tracking-widest font-medium">
