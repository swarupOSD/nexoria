...
const NexoriaMusicAllSongs = () => {
  ...
  return (
    <div className="min-h-full bg-[#121212] text-white">
      {/* Header Gradient */}
      <div className="h-64 bg-gradient-to-b from-[#2E1A47] to-[#121212] flex items-end px-6 pb-6 relative z-0">
      ...
      <div className="px-6 py-6 flex items-center gap-6 relative z-10 bg-black/10 backdrop-blur-sm">
        <button 
