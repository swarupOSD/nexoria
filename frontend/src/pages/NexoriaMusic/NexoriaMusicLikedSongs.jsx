    ...
    <div className="bg-background text-on-surface font-body-md min-h-screen relative pb-32">
      ...
      <section className="relative w-full h-[400px] md:h-[450px] overflow-hidden mb-8">
        ...
        <div className="absolute bottom-0 left-0 p-6 md:px-margin-desktop md:pb-12 w-full flex flex-col md:flex-row items-end gap-6 md:gap-8 max-w-[1440px] mx-auto z-10">
          <div className="w-48 h-48 md:w-64 md:h-64 bg-gradient-to-br from-indigo-500 to-indigo-800 shadow-[0_20px_50px_rgba(99,102,241,0.4)] flex items-center justify-center rounded-xl overflow-hidden shrink-0 mx-auto md:mx-0 border border-outline-variant/30 relative">
            <Heart className="w-24 h-24 text-white drop-shadow-lg" style={{ fontVariationSettings: "'FILL' 1" }} />
          </div>
          <div className="flex flex-col flex-1 w-full text-center md:text-left">
            ...
            <h1 className="font-display-lg text-[48px] sm:text-[64px] md:text-[80px] lg:text-[96px] font-bold tracking-tighter text-on-surface pb-2 drop-shadow-lg leading-none glow-text w-full">Liked Songs</h1>
        ...
        {tracks.length === 0 ? (
          <div className="text-center py-24 glass-card rounded-3xl border border-outline-variant/20 mx-4 md:mx-0">
            <div className="inline-block p-6 rounded-full bg-surface-container-highest mb-6 shadow-inner">
              <Heart className="w-12 h-12 text-on-surface-variant" />
            </div>
            <h3 className="font-display-lg text-headline-sm font-bold mb-3 text-on-surface">Songs you like will appear here</h3>
            <p className="font-body-md text-on-surface-variant font-medium">Save songs by tapping the heart icon.</p>
            <button 
