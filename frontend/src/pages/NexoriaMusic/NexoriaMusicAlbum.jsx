  ...
  return (
    <div className="min-h-full bg-[#0F0F23] text-white">
      ...
      <div className="sm:hidden sticky top-0 z-50 bg-[#0F0F23]/80 backdrop-blur-xl border-b border-white/5 flex items-center px-4 h-14">
        ...
        <span className="flex-1 text-center font-bold text-white text-sm truncate px-2">{album.title}</span>
          ...
          <>
            ...
            <div className="flex flex-col">
              {tracks.map((track, idx) => (
                <div 
                  key={track._id} 
                  className="grid grid-cols-[32px_1fr_80px] md:grid-cols-[32px_minmax(120px,_4fr)_minmax(120px,_1fr)] gap-4 px-4 py-2 hover:bg-white/10 group transition-colors rounded-md items-center cursor-pointer active:scale-[0.98] transition-transform"
