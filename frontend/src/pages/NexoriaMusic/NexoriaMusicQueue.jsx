...
const NexoriaMusicQueue = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#0F0F23] overflow-hidden">
      {/* Header */}
      <div className="px-6 py-4 flex items-center sticky top-0 z-20 bg-[#0F0F23]/90 backdrop-blur-md">
        <button 
          onClick={() => navigate(-1)} 
          className="w-8 h-8 rounded-full bg-[#0F0F23]/40 flex items-center justify-center hover:bg-[#0F0F23]/60 transition-colors text-white"
        >
            ...
            <div className="flex items-center justify-between p-2 rounded-md hover:bg-white/10 group">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 shrink-0 relative">
                  ...
                  />
                  {isPlaying && (
                    <div className="absolute inset-0 bg-[#0F0F23]/40 flex items-center justify-center rounded">
