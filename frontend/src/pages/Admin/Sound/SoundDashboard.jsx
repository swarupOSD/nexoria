...
const SoundDashboard = () => {
  ...
  return (
    <div className="p-4 md:p-6">
      <h1 className="text-2xl font-bold text-slate-800 dark:text-white mb-4 md:mb-6">Nexoria Sound Analytics</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-4 md:mb-8">
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
          ...
          <p className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-white">{stats.totalSongs || 0}</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
          ...
          <p className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-white">{stats.totalPlays || 0}</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
          ...
          <p className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-white">{stats.totalLikes || 0}</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
          ...
          <p className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-white">{stats.activeSongs || 0}</p>
        </div>
      </div>
