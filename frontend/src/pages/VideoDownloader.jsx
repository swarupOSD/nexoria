    ...
    <div className="min-h-screen pt-24 pb-20 relative overflow-hidden flex flex-col">
      ...
      <div className="container mx-auto px-4 z-10 flex-1 flex flex-col">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center w-full h-full min-h-[500px] md:min-h-[500px] p-8 text-center bg-[#050505]">
            <HardDrive className="w-16 h-16 text-slate-700 mb-6" />
            <h2 className="text-3xl font-bold text-white mb-4">Under Development</h2>
            <p className="text-slate-400 max-w-lg mb-8">
              The Nexoria Video Downloader backend is currently undergoing maintenance and upgrades. This feature will be available soon.
            </p>
            <div className="px-6 py-2 bg-primary/20 text-primary border border-primary/30 rounded-full font-bold">
              Coming Soon
            </div>
          </div>
        </motion.div>
