  ...
  return (
    <section id="nexus-grid" className="py-24 px-margin-mobile md:px-margin-desktop max-w-[1440px] mx-auto relative z-10">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[250px]">
        ...
        <Link to="/moviebox/games" className="md:col-span-2 lg:col-span-2 md:row-span-2 rounded-3xl p-6 md:p-8 relative overflow-hidden group border border-outline-variant/30 hover:border-outline-variant/60 hover:shadow-[0_8px_40px_rgba(76,215,246,0.15)] hover:-translate-y-1.5 transition-all duration-500 bg-[#06080a]">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div className="mt-auto backdrop-blur-md bg-black/10 p-5 rounded-2xl border border-white/5 group-hover:border-white/10 transition-colors duration-500">
              <h2 className="font-headline-lg text-3xl md:text-4xl text-white mb-2 md:mb-3 font-bold tracking-tight drop-shadow-md">Immersive Worlds Await</h2>
        ...
        {/* MovieBox */}
        <Link to="/moviebox" className="md:col-span-1 lg:col-span-1 rounded-3xl p-5 relative overflow-hidden group border border-outline-variant/30 hover:border-primary-container/60 hover:shadow-[0_8px_30px_rgba(160,120,255,0.12)] hover:-translate-y-1.5 transition-all duration-500 bg-[#0a0614]">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div className="mt-auto flex justify-between items-end group-hover:translate-y-[-2px] transition-transform duration-500 backdrop-blur-md bg-black/10 p-3.5 rounded-2xl border border-white/5">
               <div>
        ...
        {/* Apps */}
        <Link to="/apps" className="md:col-span-1 lg:col-span-1 rounded-3xl p-5 relative overflow-hidden group border border-outline-variant/30 hover:border-indigo-500/50 hover:shadow-[0_8px_30px_rgba(99,102,241,0.12)] hover:-translate-y-1.5 transition-all duration-500 bg-[#060814]">
        ...
        {/* Music */}
        <Link to="/nexoria-music" className="md:col-span-1 lg:col-span-1 rounded-3xl p-5 relative overflow-hidden group border border-outline-variant/30 hover:border-rose-500/50 hover:shadow-[0_8px_30px_rgba(244,63,94,0.12)] hover:-translate-y-1.5 transition-all duration-500 bg-[#120508]">
        ...
        {/* Arena */}
        <Link to="/nexoria-arena" className="md:col-span-1 lg:col-span-1 rounded-3xl p-5 relative overflow-hidden group border border-outline-variant/30 hover:border-amber-500/50 hover:shadow-[0_8px_30px_rgba(245,158,11,0.12)] hover:-translate-y-1.5 transition-all duration-500 bg-[#140a02]">
        ...
        {/* Aura & Community */}
        <Link to="/aura" className="md:col-span-1 lg:col-span-1 rounded-3xl p-5 relative overflow-hidden group border border-outline-variant/30 hover:border-orange-500/50 hover:shadow-[0_8px_30px_rgba(249,115,22,0.12)] hover:-translate-y-1.5 transition-all duration-500 bg-[#140804]">
        ...
        {/* Premium */}
        <Link to="/premium" className="md:col-span-1 lg:col-span-1 rounded-3xl p-5 relative overflow-hidden group border border-yellow-500/20 hover:border-yellow-400/50 hover:shadow-[0_8px_30px_rgba(250,204,21,0.15)] hover:-translate-y-1.5 transition-all duration-500 bg-[#121004]">
