  ...
  return (
    <div className="flex h-screen bg-white dark:bg-[#080312] text-slate-800 dark:text-slate-200 font-sans overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col h-full min-w-0">
        ...
        <header className="h-14 border-b border-slate-200 dark:border-white/5 bg-white/80 dark:bg-[#080312]/60 backdrop-blur-xl flex items-center justify-between px-4 lg:px-6 shrink-0">
